...
namespace AppointmentScheduling.DbInitializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                UserName = "adminRosnani@gmail.com",
                Email = "adminRosnani@gmail.com",
                EmailConfirmed = true,
                Name = "Rosnani Sohor"

            }, "Rosnani76*").GetAwaiter().GetResult();

            ApplicationUser user = _db.Users.FirstOrDefault(u => u.Email == "adminRosnani@gmail.com");
